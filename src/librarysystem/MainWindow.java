...
public class MainWindow extends JFrame implements LibWindow{	
	...
	public void init() {
		...
		lblCity.setBounds(148, 245, 121, 33);
		panelAddMember.add(lblCity);
		
		textCity = new JTextField();
		textCity.setColumns(10);
		textCity.setBounds(312, 245, 246, 33);
		...
		lblState.setBounds(148, 289, 121, 33);
		panelAddMember.add(lblState);
		
		textState = new JTextField();
		textState.setColumns(10);
		textState.setBounds(312, 289, 246, 33);
		...
		lblZiP.setBounds(148, 333, 121, 33);
		panelAddMember.add(lblZiP);
		
		textZip = new JTextField();
		textZip.setColumns(10);
		textZip.setBounds(312, 333, 246, 33);
		...
		btnAdd.setBounds(357, 398, 157, 53);
		...
		JScrollPane scrollPaneAllMemberID_1 = new JScrollPane();
		scrollPaneAllMemberID_1.setBounds(59, 87, 718, 357);
		panelAllBookIds.add(scrollPaneAllMemberID_1);
		...
		JScrollPane scrollPaneAllBookID = new JScrollPane();
		scrollPaneAllBookID.setBounds(56, 82, 718, 357);
		panelAllMemberIds.add(scrollPaneAllBookID);
